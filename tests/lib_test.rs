...
mod tests {
    ...
    fn test_metric_value_type_equality() {
        ...
        let decimal_value = MetricValueType::DecimalItemType(Decimal::new(42, 12));
        ...
        assert_eq!(
            decimal_value,
            MetricValueType::DecimalItemType(Decimal::new(42, 12))
        );
        assert_eq!(
            text_value,
            MetricValueType::TextItemType("Hello, IoT!".to_string())
        );
    }
